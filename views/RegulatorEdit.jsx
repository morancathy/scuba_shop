    ...
    return (
      ...
      styles={[{key: 0, href: '/css/app.css'}, { key: 1, href: '/css/edit.css'}]}>
        <form action={`/regulators/${this.props.regulator._id}?_method=PUT`} method="POST">
          ...
          <h4>Description:</h4>
            <textarea rows="4" cols="50" name="description" defaultValue={this.props.regulator.description}/><br/>
          <h4>Image:</h4>
            <input type="text" name="image" defaultValue={this.props.regulator.img}/><br/>
          <h4>Price:</h4>
