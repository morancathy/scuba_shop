  ...
  render(){
    return (
      ...
      styles={[{key: 0, href: '/css/app.css'}, { key: 1, href: '/css/foodnewpage.css'}]}>
        ...
        <h4>Image:</h4>
          <input type="text" name="image" defaultValue={this.props.product.img}/><br/>
        <h4>Price:</h4>
          <input type="number" placeholder="0.00" step="0.01" min="0" max="10" name="price" defaultValue={this.props.product.price}/><br/>
        <h4>Quantity:</h4>
          <input type="number" name="qty" defaultValue={this.props.product.qty}/><br/>
