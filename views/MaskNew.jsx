...
class MaskNew extends React.Component{
  render() {
    return(
      <DefaultLayout
      title={"New Product"}
      ...
      <div className="new-div">
        <a id="new-backLink" href={`/masks`}>Back</a>
          <div className="div1">
          </div>
          <div className="div2">
            <form action="/masks" method="POST">
            <h4>Product:</h4>
              <input type="text" name="product" defaultValue="mask" readOnly="readOnly" /><br/>
            <h4>Name:</h4>
